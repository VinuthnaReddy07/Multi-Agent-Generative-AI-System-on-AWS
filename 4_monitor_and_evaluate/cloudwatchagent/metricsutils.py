...
def extract_metrics(metrics_summary):
    ...
    emf_metrics = {
        "_aws": {
            ...
            "LogGroupName": "barista_supervisor-agent-metrics",  # Required for CloudWatch agent to know which log group to use
            "CloudWatchMetrics": [{
        ...
        "AgentName": "barista_supervisor-agent",
...
def save_metrics(metrics_summary, filename=os.environ['METRICS_FILE']): 
    """
